            ...
            <div className="flex-shrink-0 flex flex-col items-center gap-1 pt-3 pb-2 relative z-30 bg-[#0f1115] border-b border-white/5">
                ...
                <div className="relative">
                    ...
                    >
                        ...
                        <ChevronDown
                            size={18}
                            className={`opacity-60 transition-transform ${formationMenuOpen ? 'rotate-180' : ''}`}
                        />
                    </button>
                    ...
                    {formationMenuOpen && (
                        <>
                            ...
                            <div
                                ...
                                onClick={() => setFormationMenuOpen(false)}
                            />
                ...
                <div className="flex items-center gap-2 mt-1">
                    <button
                        onClick={autoPick}
                        className="flex items-center gap-1.5 px-3 py-1 rounded-md text-[11px] font-bold text-amber-400 bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 transition-colors"
                    >
                        <Wand2 size={11} /> Auto Pick
                    </button>
                    <button
                        onClick={clearPitch}
                        className="flex items-center gap-1.5 px-3 py-1 rounded-md text-[11px] font-bold text-red-400 bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 transition-colors"
                    >
                ...
                <div className="grid grid-cols-12 gap-4 h-full max-w-[1920px] mx-auto">
                    ...
                    <div className="col-span-8 flex items-center justify-center relative">
                        ...
                        <div className="absolute bottom-2 right-2 bg-black/55 backdrop-blur px-2 py-1 rounded-lg text-[11px] text-gray-400">
                            <span className={assignedCount === 11 ? 'text-green-400 font-bold' : ''}>
                                {assignedCount}
                            </span>
